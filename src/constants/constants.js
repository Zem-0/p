...
export const TimeLineData = [
  { year: 2017, text: "Founded Gyaantrix Technologies Pvt. Ltd." },
  { year: 2018, text: "Received grants totaling ₹1 lakh from IIT Hyderabad for innovative projects" },
  { year: 2019, text: "Won first and second prizes in the MITS Innovation Challenge" },
  { year: 2021, text: "Selected for prestigious programs like Microsoft Founders Hub and Google Startup School." },
  { year: 2022, text: ". Selected as a finalist in startup fairs at IIT Hyderabad, IIT Bombay, VNIT Nagpur, and IIT Madras." },
];
